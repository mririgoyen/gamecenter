...
var AvatarComponent = /** @class */ (function (_super) {
    ...
    AvatarComponent.prototype.render = function () {
        var _a = this.props, avatarStyle = _a.avatarStyle, circleColor = _a.circleColor, style = _a.style;
        return React.createElement(avatar_1.default, { avatarStyle: avatarStyle, circleColor: circleColor, style: style });
    };
